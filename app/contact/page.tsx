...
export default function Contact() {
  ...
  const offices = [
    {
      city: t("contact.corporateOffice", "Corporate Office (New Delhi)"),
      address: t(
        "contact.corporateAddress",
        "B-22, Okhla Industrial Area, Phase-III, New Delhi, 110020"
      ),
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <MarketplacePageHero
        eyebrow={t("contact.eyebrow", "Support")}
        title={t("contact.title", "Get in Touch with Our Team")}
        subtitle={t(
          "contact.subtitle",
            ...
            <div className="space-y-6 lg:col-span-5">
              <div className="space-y-4">
                ...
                {offices.map((office, idx) => (
                  <div key={idx} className="surface-card space-y-3 p-5">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                <div className="surface-card space-y-2 p-5">
                  ...
                  <div className="space-y-1 pl-6 text-xs text-muted-fg">
                    <p>{t("contact.monFri", "Monday - Friday: 9:00 AM - 6:00 PM")}</p>
                    <p>{t("contact.sat", "Saturday: 9:00 AM - 2:00 PM")}</p>
                    <p className="font-semibold text-primary">
                      {t("contact.sun", "Sunday: Closed")}
                    </p>
                  </div>
                </div>
                ...
                <div className="surface-card space-y-3 p-5">
                  <h4 className="text-sm font-semibold text-foreground">
                    {t("contact.connectSocially", "Connect Socially")}
                  </h4>
