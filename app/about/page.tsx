          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
            ...
            <div className="flex justify-center lg:col-span-5">
              <motion.div
                ...
                viewport={{ once: true }}
                className="w-full max-w-md rounded-xl border border-border bg-gradient-to-br from-muted to-card p-6"
              >
        ...
        <div className={MARKETPLACE_CONTAINER}>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="surface-card-hover p-8 lg:row-span-2"
            >
              <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-primary-soft text-primary">
                <Shield className="h-5 w-5" />
              </div>
              <h3 className="mb-2 text-lg font-semibold text-foreground">{values[0].title}</h3>
          ...
          <div className="mt-4">
            ...
            >
              ...
              <h3 className="mb-2 text-sm font-semibold text-foreground">{values[3].title}</h3>
            ...
            {(() => {
              ...
              return (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="group flex flex-col surface-card-hover p-8 lg:row-span-2"
                >
            ...
            {roleCards.slice(1).map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group flex flex-col surface-card-hover p-5"
                >
                  <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-primary-soft text-primary">
                    <Icon className="h-5 w-5" />
                  </div>
